window.onload = function () {
    ...
    function gameOver() {
        ...
        context.strokeText("GAME OVER",xCenter,yCenter-180);
        context.fillText("GAME OVER",xCenter,yCenter-180);
        context.font = "bold 30px sans-serif";
        context.fillText("Appuyer sur la touche espace pour rejouer",xCenter,yCenter-120);
        context.restore();
    }
    ...
    function showScore() {
        ...
        let xCenter = canvasWidth/2;
        let yCenter = canvasHeight/2;
        context.fillText(score.toString(),xCenter,yCenter);
        context.restore();
    }
